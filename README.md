...
Tiles are 16x16, by default the game will scale from 480x270.<br>
...
as compile the game outputting it in ./bin<br>
On linux it also checks for wayland using WAYLAND_DISPLAY<br><br>
To build manually:
``nim c [options] ./src/game.nim
mkdir ./bin && mv ./src/game.nim ./bin``<br>
